...
export default function TopBar({ onExportJson, onExportPdf, hasReport, onNewAnalysis, onOpenSettings }: TopBarProps) {
    return (
        <header className="topbar">
            ...
            <div className="topbar-right">
                {hasReport && (
                    <>
                        <button onClick={onExportJson} className="topbar-btn" title="Export JSON">
